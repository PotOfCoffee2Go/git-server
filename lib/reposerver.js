...
exports.repoServer = function repoServer(config) {
	const { repoDir, repoPort, proxyPort, allowNetworkAccess, allowAnonymousPush, users } = config;
	usersInfo = users; allowAnonymous = allowAnonymousPush;
